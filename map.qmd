...
<div style='font-family:sans-serif; font-size:13px; max-width:300px;'>
  ...
  <div style='display:none; font-size:12px; margin-top:4px;'>
    This index ranks counties from 1 (low) to 5 (high) based on the level of civic opportunity available. Each organization gets a score depending on whether it offers volunteering, membership, public events, or take-action activities. We average these to get a score from 0 to 1. Then we add up all the scores in a county, adjust for the county's population size, and sort counties into five equal groups.
  </div><br/>
  {index_boxes}
