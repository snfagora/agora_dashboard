...
async function loadChatbot() {
  ...
  const [countsText, orgText, lookupText] = await Promise.all([
    fetch('raw_data/cnty_counts_cov.csv').then((res) => res.text()),
    fetch('raw_data/cnty_civic_org_type.csv').then((res) => res.text()),
    fetch('raw_data/county_lookup.csv').then((res) => res.text())
  ]);
